...
public class FCOListVM {
	
public static String fcotext = "fcotext";
	...
	public void listvms(String cloudusername, String cloudpassword,
		...
		requestContext.update("FCOOUTPUT");
		/*
		...
		try {
			...
			for (Object o : result.getList()) {
				...
				FCOCheckKeys checkkey = new FCOCheckKeys();
				...
				Globals.fcotext= Globals.fcotext + "Server "+ s.getResourceUUID() + " is in state " + s.getStatus();
			...
			Globals.fcotext= Globals.fcotext + "Server random from list " + vmuuid;
			RequestContext requestContext4 = RequestContext.getCurrentInstance();
			requestContext4.update("FCOOUTPUT");
